<p> Untuk database bapak bisa melakukan: </p>
<h3>
    php artisan migrate:refresh --seed
</h3>
<p>
    Hal ini dikarenakan kami memiliki data seeders yang bisa digunakan, namun apa bila tidak bisa bapak bisa mengdownload nya di link berikut:
</p>
<h3>
